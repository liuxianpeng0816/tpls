...
/*背景色*/
  .color2 .b2, .color2 .b3, .color2 .b4, .color2 .b5, .color2 .b6, .color2 .b7, .color2 .content {background:#a5d932;} #news_warp {
        ...
        .downlaod_insert {background:url(http://w.qhimg.com/images/v2/360se/2011/kouxin/recommend/pic05_unknown.jpg) no-repeat left top #ddefff; height:171px; width:308px;} .description {
    ...
    <div id="news">
        <div class="sharp color2">
            ...
            <div class="content">
                ...
                <div class="msg_play">
                    <a href="{%$imagesrcbig%}"><img width="195" src="{%$imagesrcsmall%}" alt="点击查看原图"></a>
                    <span>(点击查看原图)</span>
                </div>
            </div>
    ...
    <div class="downlaod_insert">
        <div class="description">
            ...
            <a href="{%$downloadurl%}"><img
                        src="http://w.qhimg.com/images/v2/360se/2011/kouxin/recommend/btn_down_5800.jpg" alt="免费下载"></a>
        </div>
    </div>
</div>
</body>
