...
/*背景色*/
  .color2 .b2, .color2 .b3, .color2 .b4, .color2 .b5, .color2 .b6, .color2 .b7, .color2 .content {background:#a5d932;} #news_warp {
        ...
        {color:#456300; font-weight:normal;}
    </style>
</head>
<body>
<div id="header">
...
<div id="news_warp">
    <div id="news">
        <div class="sharp color2">
            ...
            <div class="content">
                <p>删除该消息后，将无法再次查看，是否要继续删除？</p>

                <div class="msg_play">
                    <a href="{%$pre_url%}"><span style="padding-right:70px;">取消</span></a>
                    <a target="_blank" href="{%$dodelurl%}"><span style="color:red; ">继续删除</span></a>
                </div>
            </div>
