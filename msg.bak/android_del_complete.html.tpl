...
/*背景色*/
  .color2 .b2, .color2 .b3, .color2 .b4, .color2 .b5, .color2 .b6, .color2 .b7, .color2 .content {background:#f5f5f5;} #header {
        ...
        #msg_content {margin:0 20px 0 20px;} #player_box {
            background: url(http://w.qhimg.com/images/v2/360se/2011/kouxin/wapandroid/pic_xiaoan2.png) no-repeat;
            margin: 5px 0 0 0;
            margin-left: 15px;
            height: 75px;
            text-align: center;
...
<div id="wrap">
    ...
    <div id="msg">
        ...
        <div id="operate">
            <p><b style="font-size:16px">您可以：</b></p>

            <p>1. 让您的朋友再次分享超级短信附件。</p>

            <p>2. 免费安装360安全通讯录，自动将超级短信消息保存到手机中。</p>
        </div>
