        ...
        <div id="msg_content">
            ...
            <div class="color2">
                ...
                <div class="content">
                    ...
                    <div id="player_box">
                        <a href="{%$imagesrcbig%}"><img alt="alt=" 点击查看原图"" src="{%$imagesrcsmall%}" width="180px"/></a>

                        <p class="fplay">点击查看原图</p>
                    </div>
                </div>
                ...
                <tr>
                    <td>
                        <table border="0" cellpadding="0" cellspacing="0" align="center" width="260">
                            <tr>
                                <td id="oper_blue"><a href="{%$downsrcbig%}">保存至手机</a></td>
