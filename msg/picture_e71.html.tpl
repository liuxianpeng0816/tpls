...
<head>
    ...
    <style type=text/css>
        ...
        a {color:#456300; text-decoration: underline} a:hover {color:#456300;} .clear {
            clear: both;
        }
...
/*背景色*/
  .color2 .b2, .color2 .b3, .color2 .b4, .color2 .b5, .color2 .b6, .color2 .b7, .color2 .content {background:#a5d932;} #news_warp {
        ...
        .msg_play img {
            float: left;
            width: 110px;
            border: 1px solid #91c421;
        }

        .msg_play img a:hover {
            border: 1px solid #effcd2;
        }
    ...
    <div id="news">
        <div class="sharp color2">
            ...
            <div class="content">
                ...
                <div class="msg_play">
                    <a href="{%$imagesrcbig%}"><img width="110" src="{%$imagesrcsmall%}" alt="点击查看原图"></a>
                    <span><a href="{%$imagesrcbig%}">(查看原图)</a></span>
