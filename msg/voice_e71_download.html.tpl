...
/*背景色*/
  .color2 .b2, .color2 .b3, .color2 .b4, .color2 .b5, .color2 .b6, .color2 .b7, .color2 .content {background:#a5d932;} .b11 {height:1px; font-size:1px; overflow:hidden; display:block;} .b21 {height:1px; font-size:1px; overflow:hidden; display:block;} .b31 {height:1px; font-size:1px; overflow:hidden; display:block;} .b61 {height:1px; font-size:1px; overflow:hidden; display:block;} .b71 {height:1px; font-size:1px; overflow:hidden; display:block;} .b81 {height:1px; font-size:1px; overflow:hidden; display:block;} #downlaod {
            background-color: #ddefff;
            padding: 6px 0 0 12px;
            border-top: 1px solid #97bedf;
        }

        .downlaod_insert {background:url(http://w.qhimg.com/images/v2/360se/2011/kouxin/recommend/hp_pic05.jpg) no-repeat left top #ddefff; height:55px; width:305px;} .description {
...
<body>
<div id="header">
    <div class="logo"><img src="http://w.qhimg.com/images/v2/360se/2011/kouxin/recommend/hp_logo.jpg" alt="360安全通讯录">
    </div>
</div>
<div id="news_warp">
    <div id="news">
        <div class="sharp color2">
            ...
            <div class="content">
                ...
                <div class="msg_play">
                    <a href="{%$audiosrc%}"><img
                                src="http://w.qhimg.com/images/v2/360se/2011/kouxin/recommend/hp_icon_play_new.jpg"
                                alt="点击播放"></a>
                    <span>(点击收听)</span>
...
<div id="downlaod">
    <div class="downlaod_insert">
        <div class="description">
            <ul>
                <li><h2>360安全通讯录</h2></li>
                <li><a href="{%$downloadurl%}"><img
                                src="http://w.qhimg.com/images/v2/360se/2011/kouxin/recommend/hp_btn_down.jpg"
                                alt="免费下载"></a></li>
                <div class="clear"></div>
            </ul>
            <p>骚扰拦截 数据备份 快速搜索 便捷群发</p>
        </div>
    </div>
</div>
</body>
